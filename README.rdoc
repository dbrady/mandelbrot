...
change a hardcode to get it to switch. Update: Nope, it generates the
left half of the image. Look at lines 29-30, comment out line 30 to
set half=RIGHT_HALF and generate the other half of the image.
...
== Files
*genimage.rb* Is the generator. All the parameters are hard-coded,
...
*mandelbrot.rb* This is just a scratch file where I experimented with
 the "twitterable" version, trying to reduce the number of characters
 as much as possible.

*brahbur.rb* Brahbur's mandelbrot solution, which was the first major
